import { resolveSidebarIconStripBarAreaPatch } from "../../sidebar-element/index.js";
import {
  createPointerInteraction,
  createPointerOperation
} from "./pointerOperationAdapter.js";

export const SIDEBAR_ICON_STRIP_BAR_AREA_POINTER_TYPES = {
  MOVE: "move",
  RESIZE: "resize"
};

export function createSidebarIconStripBarAreaPointerInteraction({
  event,
...
export function createSidebarIconStripBarAreaPointerMove({
  event,
  interaction,
  metrics
} = {}) {
  ...
  const barArea = resolveSidebarIconStripBarAreaPatch({
    absoluteArea,
    metrics
  });
