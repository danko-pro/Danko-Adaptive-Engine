...
export const LAYOUT_RELATION_PROJECTION_STRATEGIES = {
  STACK: "stack"
};

export const DEFAULT_LAYOUT_RELATION_PROJECTION_STRATEGY =
  LAYOUT_RELATION_PROJECTION_STRATEGIES.STACK;

export const DEFAULT_LAYOUT_RELATIONS = {
  version: 1,
  strategy: DEFAULT_LAYOUT_RELATION_PROJECTION_STRATEGY,
  children: []
};
